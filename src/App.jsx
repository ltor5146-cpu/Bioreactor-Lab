        ...
        <div style={formPanel}>
          ...
          <div style={{ marginBottom: 26 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14, marginBottom: 10 }}>
              <img src={`${import.meta.env.BASE_URL}bridge_capital_logo.png?v=5`} alt="Bridge Capital Financial Solutions" style={{ height: 180, width: "auto", objectFit: "contain", display: "block" }} />
